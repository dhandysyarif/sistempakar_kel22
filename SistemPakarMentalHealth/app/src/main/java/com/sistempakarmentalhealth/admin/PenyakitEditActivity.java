package com.sistempakarmentalhealth.admin;
...
import com.sistempakarmentalhealth.MySingleton;
...
public class PenyakitEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.10/sp_mentalhealth/get_penyakit.php";
    private static final String url_update = "http://192.168.1.10/sp_mentalhealth/update_penyakit.php";
    private static final String url_delete = "http://192.168.1.10/sp_mentalhealth/delete_penyakit.php";
