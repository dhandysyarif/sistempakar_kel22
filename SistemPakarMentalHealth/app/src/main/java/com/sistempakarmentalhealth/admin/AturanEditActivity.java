...
public class AturanEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.10/sp_mentalhealth/get_daftar_gejala.php";
    private static final String url_update = "http://192.168.1.10/sp_mentalhealth/update_aturan.php";
