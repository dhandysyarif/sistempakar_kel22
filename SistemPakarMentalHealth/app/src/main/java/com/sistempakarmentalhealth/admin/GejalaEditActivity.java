...
public class GejalaEditActivity extends AppCompatActivity {
    ...
    private static final String url = "http://192.168.1.10/sp_mentalhealth/get_gejala.php";
    private static final String url_update = "http://192.168.1.10/sp_mentalhealth/update_gejala.php";
    private static final String url_delete = "http://192.168.1.10/sp_mentalhealth/delete_gejala.php";
